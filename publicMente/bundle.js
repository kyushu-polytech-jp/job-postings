...
var Ut, Ht2, DocumentSnapshot$1, QueryDocumentSnapshot$1, AppliableConstraint, QueryConstraint, QueryFieldFilterConstraint, QueryCompositeFilterConstraint, QueryOrderByConstraint, QueryLimitConstraint, SnapshotMetadata, DocumentSnapshot, QueryDocumentSnapshot, QuerySnapshot;
...
var init_index_36fcbc82 = __esm({
  "node_modules/@firebase/auth/dist/esm/index-36fcbc82.js"() {
    ...
    UserImpl = class _UserImpl {
      constructor(_a) {
        var _b = _a, { uid, auth: auth2, stsTokenManager } = _b, opt = __objRest(_b, ["uid", "auth", "stsTokenManager"]);
      ...
      static _fromJSON(auth2, object) {
        ...
        const tenantId = (_e2 = object.tenantId) != null ? _e2 : void 0;
    ...
    PasswordPolicyImpl = class {
      ...
      validatePassword(password) {
        ...
        status.isValid && (status.isValid = (_e2 = status.containsNumericCharacter) != null ? _e2 : true);
    ...
    PhoneAuthCredential = class _PhoneAuthCredential extends AuthCredential {
      ...
      /** @internal */
      _linkToIdToken(auth2, idToken) {
        return linkWithPhoneNumber$1(auth2, __spreadValues({
          idToken
...
var require_main = __commonJS({
  "publicMente/main.ts"() {
    ...
    var inputReceptionYear = document.getElementById("inputReceptionYear");
    var inputReceptionNumber = document.getElementById("inputReceptionNumber");
    var newRegistrationBtn = document.getElementById("newRegistrationBtn");
    var confirmModifyBtn = document.getElementById("confirmModifyBtn");
    var deleteBtn = document.getElementById("deleteBtn");
    var recruitmentYearField = document.getElementById("recruitmentYear");
    var receptionNumberField = document.getElementById("receptionNumber");
    var recruitingDepartmentsDiv = document.getElementById("recruitingDepartments");
    var ownerNameField = document.getElementById("ownerName");
    var ownerNameKanaField = document.getElementById("ownerNameKana");
    var postalCodeField = document.getElementById("postalCode");
    var prefectureField = document.getElementById("prefecture");
    var addressField = document.getElementById("address");
    var buildingNameField = document.getElementById("buildingName");
    var phoneNumberField = document.getElementById("phoneNumber");
    var capitalField = document.getElementById("capital");
    var numberOfEmployeesField = document.getElementById("numberOfEmployees");
    var companyTypeField = document.getElementById("companyType");
    var industryClassificationField = document.getElementById("industryClassification");
    ...
    async function getMaxReceptionNumber(yearNumber) {
      try {
        const jobPostingsCol = collection(db, "jobPostings");
        const q = query(
          jobPostingsCol,
